...
public abstract class BaseComputer extends BaseProduct implements Computer {
    ...
    public Peripheral removePeripheral(String peripheralType) {
        if (components.stream().noneMatch(c -> c.getClass().getSimpleName().equals(peripheralType))) {
    ...
    public String toString() {
        ...
        builder.append(String.format(" " +COMPUTER_PERIPHERALS_TO_STRING, peripherals.size(),peripherals.
                stream().mapToDouble(Peripheral::getOverallPerformance).average().orElse(0)));
